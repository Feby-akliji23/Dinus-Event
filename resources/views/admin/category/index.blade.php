                ...
                <tbody class="text-slate-700">
                    @forelse ($categories as $index => $category)
                        <tr>
                            ...
                            <td>{{ $category->nama }}</td>
                            <td>
                                <button class="btn btn-sm btn-outline mr-2" onclick="openEditModal(this)" data-id="{{ $category->id }}" data-nama="{{ $category->nama }}">Edit</button>
                                <button class="btn btn-sm btn-error" onclick="openDeleteModal(this)" data-id="{{ $category->id }}">Hapus</button>
                            </td>
                        </tr>
                        @empty
                        <tr>
